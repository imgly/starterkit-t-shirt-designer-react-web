...
/**
 * Configure engine settings for the product editor.
 *
...
export function setupSettings(engine: CreativeEngine): void {
  ...
  // Disable dimming of out-of-page areas
  // This is critical for product editing - the mockup image extends beyond
  // the printable area (page) and should remain fully visible
  ...
  // Hide page titles since product areas use custom names
  ...
  // Enable background grid display
  // engine.editor.setSettingBool('grid/enabled', true);

  // Enable snap-to-grid for precise element positioning
